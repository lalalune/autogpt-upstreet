"""This is the AutoGPT Upstreet Plugin."""
from typing import Any, Dict, List, Optional, Tuple, TypeVar
from colorama import Fore
from auto_gpt_plugin_template import AutoGPTPluginTemplate

from .upstreet_plugin import run_bot, Message, messagesToSend, userReply, waitingForReply, finishedLoggingIn
import threading
import time
import os
...
class AutoGPTUpstreet(AutoGPTPluginTemplate):
    """
    This the AutoGPT Upstreet Plugin..
    """

    def __init__(self):
        super().__init__()
        self._name = "AutoGPTUpstreet"
        self._version = "0.1.1"
        self._description = "AutoGPT Upstreet Plugin: Interact with Upstreet from AutoGPT."
